        ...
        @switch (option.id) {
          @case ('layout') {
            ...
            >
              ...
              <!-- Largeur -->
              <app-select-control label="Largeur">
              ...
              <div class="mb-4">
                ...
                <input type="number" class="w-full border border-gray-300 rounded px-2 py-1 text-xs focus:border-blue-500 outline-none" value="0">
              </div>

              <!-- Taille -->
              <app-select-control label="Taille">
                <option>Par défaut</option>
                <option>Personnalisé</option>
              </app-select-control>

              <!-- Position -->
              <app-select-control label="Position">
                <option>Par défaut</option>
              ...
              <div class="mb-4">
                ...
                <input type="text" class="w-full border border-gray-300 rounded px-2 py-1 text-xs focus:border-blue-500 outline-none" placeholder="element-id">
              </div>
            </app-collapsible-section>
          }
